...
path = "./label/outer/"
files = [
    "merged_bikelocation_POI_filtered_outer",
    "merged_buslocation_POI_filtered_outer",
    "merged_trainlocation_POI_filtered_outer"
]
output_files = ["merged_bikelocation_POI_filtered_outer_wr.csv",
    "merged_buslocation_POI_filtered_outer_wr.csv",
    "merged_trainlocation_POI_filtered_outer_wr.csv"]
...
for file in files:
    ...
    df.to_csv(path + file + '_wr.csv', index=False)